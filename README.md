...
```
This command will create your personal repository under `/Repos/<username>/mlops_project`.
...
- To trigger the release pipeline, get the current version from the `mlops_project/__init__.py` file and tag the current code version:
```
