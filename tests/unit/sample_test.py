from mlops_project.tasks.sample_etl_task import SampleETLTask
from mlops_project.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/mlops-project/sample_experiment"
    }
